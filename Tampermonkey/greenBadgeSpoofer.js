...
(function () {
   ...
   if ($('#quarantineBadge').length) {
      document.getElementById("quarantineBadge").setAttribute("class", "badge-Green");
      var node_element = document.querySelectorAll('div[class*="rplt-node"]');
      node_element[node_element.length-1].style.color = 'white';
      node_element[node_element.length-1].style.backgroundColor = 'limegreen';
      node_element[node_element.length-1].style.fontSize = '0.8em';
...
DB. support functions
    */}
    ...
    if (runScript) {
        ...
        var date_str = "Next Survey Due: " + mm + "/" + dd + "/" + yyyy + " 10:00 AM";
        let replaceRules = [
            //[//i, ""], // rule template
            [/Overdue/i, "Cleared"],
            [/Lab Test is Cleared/i, date_str],
